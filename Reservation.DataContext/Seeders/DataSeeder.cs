...
namespace Reservation
{
    public static class DataSeeder
    {
        public static async Task SeedDataAsync(IServiceProvider serviceProvider)
        {
            ...
            var defaultAmenities = new[] { "Wifi", "Klíma", "Szauna", "Medence", "Ingyenes parkolás", "Okostévé", "Mosógép", "Konyha", "Erkély", "Kisállat bevihető", "Kandalló", "Jakuzzi" };
            ...
            var adjectives = new[] { "Panorámás", "Modern", "Luxus", "Hangulatos", "Romantikus", "Családbarát", "Erdei", "Vízparti", "Exkluzív", "Napfényes" };
            var types = new[] { "Apartman", "Vendégház", "Villa", "Stúdió", "Faház", "Nyaraló", "Kastély", "Lakás" };
            var locations = new[] { "Budapest, V. kerület", "Balatonfüred", "Siófok", "Veszprém", "Eger", "Sopron", "Pécs", "Győr", "Hévíz", "Zalakaros", "Szeged", "Debrecen", "Tihany" };
