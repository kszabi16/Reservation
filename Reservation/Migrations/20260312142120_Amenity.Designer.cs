...
namespace Reservation.Migrations
{
    ...
    [Migration("20260312142120_Amenity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reservation.DataContext.Entities.Amenity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 13,
                            Name = "Grillezési lehetőség"
                        },
                        new
                        {
                            Id = 14,
                            Name = "Reggeli biztosított"
                        },
                        new
                        {
                            Id = 15,
                            Name = "Elektromos autó töltő"
                        });
                });
            ...
            modelBuilder.Entity("Reservation.DataContext.Entities.PropertyAmenity", b =>
                {
                    b.Property<int>("PropertyId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Reservation.DataContext.Entities.PropertyImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Reservation.DataContext.Entities.SystemLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Reservation.DataContext.Entities.PropertyAmenity", b =>
                {
                    b.HasOne("Reservation.DataContext.Entities.Amenity", "Amenity")
